...
| TL-E03–TL-E08 | Frozen protocols, implementations, validators and the four-instrument source archive | Method, event boundary, adjudication code and compact recorded results | Full native replay requires the source training/CSRG bundles identified by the manifests |
