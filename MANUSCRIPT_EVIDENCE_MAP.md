...
| Identity-aligned target margins connect internal response and support change to the four observable transitions across a target-specific readout boundary. | **TL-E08** | [identity-aligned experiment](experiments/gfg_nanogpt_identity_aligned_margin_crossing_v1/experiment.py) | Identities and boundary transitions are established by the experiment's generated ledgers and validated through the shared source-GFG identities recorded in [SOURCE_MANIFEST.md](SOURCE_MANIFEST.md). |
